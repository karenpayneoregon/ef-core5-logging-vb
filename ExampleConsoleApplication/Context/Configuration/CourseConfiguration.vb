...
Namespace Context.Configuration
	Public Class CourseConfiguration
		...
		Public Sub Configure(builder As EntityTypeBuilder(Of Course)) Implements IEntityTypeConfiguration(Of Course).Configure
			...
			builder.HasOne(Function(d) d.Department).WithMany(Function(p) p.Courses).HasForeignKey(Function(d) d.DepartmentID).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_Course_Department")
		End Sub
